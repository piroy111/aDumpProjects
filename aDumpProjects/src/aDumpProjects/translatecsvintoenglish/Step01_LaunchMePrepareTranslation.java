...
public class Step01_LaunchMePrepareTranslation {

	/*
	 * Step 00: put the game extracted of Thibault in 'C:\Game - Stranded dreams - translation\loc'
	...
	public static void main(String[] _sArgs) {
		new TRManager().prepareTranslation();
	}
